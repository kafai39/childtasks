...
[
    ...
    {text:"START GAME", width:260, helpText:"(FAST SPEED + 5 LIVES)"},
...
function mainMenu(deltaTime)
{
    ...
    {
        let isHighlighted = aw.mousePos.y >= (yMenu + yMenuStep*i) * screenScale && aw.mousePos.y < (yMenu + yMenuStep*(i + 1)) * screenScale && aw.mousePos.x >= 0 && aw.mousePos.x < menuOptions[i].width  * screenScale;
